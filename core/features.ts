...
export const FEATURES = [
  {id:"roster",label:"roster",helpVerbs:["who","where","quit"]},
  {id:"messages",label:"messages",helpVerbs:["log","say","msg","clear"]},
  {id:"work",label:"work items",helpVerbs:["doing","did","step","add","done","board","link","plans","mine","breaks","needs"]},
  ...
  {id:"memories",label:"personal memories",helpVerbs:["remember","about-me","forget"]},
  ...
  {id:"obligations",label:"obligations",helpVerbs:["ask","request","promise","handoff","act","obligation"]},
